...
IL_019a:
	{
		...
		NullCheck(L_89);
		Type_t* L_90;
		L_90 = VirtualFuncInvoker0< Type_t* >::Invoke(25, L_89);
...
IL_009f:
	{
		...
		NullCheck(L_28);
		String_t* L_29;
		L_29 = VirtualFuncInvoker0< String_t* >::Invoke(35, L_28);
		G_B14_0 = L_29;
		G_B14_1 = G_B13_0;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR ReflectionObject_tBC7C0875C7434F4B89AC4948A4ECBD5CF84AE2E7* KeyValuePairConverter_InitializeReflectionObject_mECD1547C1FDDAE2A63C8FE1C2B2E45AE555B16F3 (Type_t* ___0_t, const RuntimeMethod* method) 
{
	...
	Type_t* V_1 = NULL;
	{
		...
		L_1 = VirtualFuncInvoker0< TypeU5BU5D_t97234E1129B564EB38B8D85CAC2AD8B5B9522FFB* >::Invoke(59, L_0);
...
IL_001e:
	{
		...
		NullCheck(L_9);
		bool L_11;
		L_11 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(31, L_9, L_10);
		if (!L_11)
		{
			goto IL_00b2;
		}
...
IL_00b2:
	{
		...
		NullCheck(L_38);
		bool L_40;
		L_40 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(31, L_38, L_39);
		if (!L_40)
		{
			goto IL_011a;
		}
