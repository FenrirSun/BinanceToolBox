...
namespace M3C.Finance.BinanceSdk
{
    public partial class BinanceClient
    {
        ...
        public async Task<DepthResponse> Depth(string symbol, int? limit = null) {
            ...
            return await SendRequest("depth", ApiVersion.Version1, ApiMethodType.None, HttpMethod.Get, parameters,
                CustomJsonParsers.DepthResponseParser);
        }
        ...
        public async Task<List<AggregateTradeResponseItem>> AggregateTrades(string symbol, long? fromId = null, long? startTime = null,
            ...
            return await SendRequest<List<AggregateTradeResponseItem>>("aggTrades", ApiVersion.Version1, ApiMethodType.None, HttpMethod.Get,
                parameters);
        }

        public List<AggregateTradeResponseItem> AggregateTradesSync(string symbol, long? fromId = null, long? startTime = null, long? endTime = null,
            int? limit = null)
            => AggregateTrades(symbol, fromId, startTime, endTime, limit).Result;

        public async Task<IEnumerable<KLinesResponseItem>> KLines(string symbol, KlineInterval interval, int? limit = null, long? startTime = null,
            long? endTime = null) {
            ...
            return await SendRequest("klines", ApiVersion.Version1, ApiMethodType.None, HttpMethod.Get, parameters,
                CustomJsonParsers.KLineResponseParser);
        }

        public IEnumerable<KLinesResponseItem> KLinesSync(string symbol, KlineInterval interval, int? limit = null, long? startTime = null,
            long? endTime = null)
