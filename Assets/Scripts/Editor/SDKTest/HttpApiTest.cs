...
namespace binance.dex.sdk.test
{
    public class HttpApiTest
    {
        ...
        public void NodeInfoTest()
        {
            ...
            Assert.IsNotNull(infos.NodeInfo);
        }
        ...
        public void ValidatorsTest()
        {
            ...
            Assert.IsNotNull(validator.Validators[0].Address);
        }
        ...
        public void AccountTest()
        {
            ...
            Assert.AreNotEqual(0, account.AccountNumber);
        }
        ...
        public void AccountSequenceTest()
        {
            ...
            Assert.AreNotEqual(0, accountSequence.Sequence);
        }
