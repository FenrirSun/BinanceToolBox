...
namespace binance.dex.sdk.test
{
    public class WalletTest
    {
        ...
        public void AddressTest()
        {
            ...
            Assert.AreEqual("tbnb1qn2w8mjmykelskltc8w9zy03q8sg7k9wllp9gu", wallet.Address);
        ...
        public void AddressTest2()
        {
            ...
            Assert.AreEqual("tbnb18086qc9yxtk5ufddple8upf0k3072vvagpm2ml", wallet.Address);
        }
        ...
        public void WordsTest()
        {
            ...
            Assert.AreEqual(address, wallet1.Address);
            Assert.AreEqual(address, wallet2.Address);
        }
        ...
        public void RandomWordsTest()
        {
            ...
            Assert.AreEqual(24, mnemonicCode.Split(' ').Length);
        }
    }
}
